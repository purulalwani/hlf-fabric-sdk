...
public class HFJavaSDKBasicExample {
    ...
    public static void sendTransaction(HFClient client, Channel channel) throws ProposalException, InvalidArgumentException, InterruptedException, ExecutionException, TimeoutException{
    	TransactionProposalRequest tpr = client.newTransactionProposalRequest();
    	ChaincodeID cid = ChaincodeID.newBuilder().setName("fabcar").build();
    	tpr.setChaincodeID(cid);
    	tpr.setFcn("createCar");
    	tpr.setArgs(new String[]{"CAR12", "Maruti", "Alto", "Silver", "Puru"});
